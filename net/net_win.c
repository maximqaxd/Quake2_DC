...
void NetadrToSockadr (netadr_t *a, struct sockaddr *s)
{
	...
	else if (a->type == NA_IPX)
	{
		...
		memcpy_fast(((struct sockaddr_ipx *)s)->sa_netnum, &a->ipx[0], 4);
		memcpy_fast(((struct sockaddr_ipx *)s)->sa_nodenum, &a->ipx[4], 6);
...
void SockadrToNetadr (struct sockaddr *s, netadr_t *a)
{
	...
	{
		a->type = NA_IPX;
		memcpy_fast(&a->ipx[0], ((struct sockaddr_ipx *)s)->sa_netnum, 4);
		memcpy_fast(&a->ipx[4], ((struct sockaddr_ipx *)s)->sa_nodenum, 6);
